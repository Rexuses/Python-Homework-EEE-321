...
# Form implementation generated from reading ui file 'FiboPlot.ui'
#
...
"}")
        ...
        self.RandomFibo = QtWidgets.QPushButton(self.centralwidget)
        self.RandomFibo.setObjectName("RandomFibo")
        self.RandomFibo.clicked.connect(self.Randomize)
        self.gridLayout.addWidget(self.RandomFibo, 4, 0, 1, 2)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setMinimumSize(QtCore.QSize(197, 0))
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 3, 0, 1, 1)
        self.FiboCal = QtWidgets.QPushButton(self.centralwidget)
        self.FiboCal.setObjectName("FiboCal")
        self.FiboCal.clicked.connect(self.FiboCall)
        self.gridLayout.addWidget(self.FiboCal, 5, 0, 1, 2)
        self.ReLabel = QtWidgets.QLabel(self.centralwidget)
        self.ReLabel.setMinimumSize(QtCore.QSize(197, 0))
        self.ReLabel.setObjectName("ReLabel")
        self.gridLayout.addWidget(self.ReLabel, 1, 0, 1, 1)
        self.FiboResult = QtWidgets.QLabel(self.centralwidget)
        self.FiboResult.setObjectName("FiboResult")
        self.gridLayout.addWidget(self.FiboResult, 3, 1, 1, 1)
        self.Requested = QtWidgets.QLineEdit(self.centralwidget)
        self.Requested.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.Requested.setObjectName("Requested")
        self.Requested.setAlignment(QtCore.Qt.AlignCenter)
        self.gridLayout.addWidget(self.Requested, 6, 0, 1, 2)
        self.ReqNumber = QtWidgets.QLabel(self.centralwidget)
        self.ReqNumber.setMinimumSize(QtCore.QSize(196, 0))
        self.ReqNumber.setText("")
        self.ReqNumber.setObjectName("ReqNumber")
        self.gridLayout.addWidget(self.ReqNumber, 1, 1, 1, 1)
    ...
    def retranslateUi(self, FiboBinary):
        ...
        FiboBinary.setWindowTitle(_translate("FiboBinary", "Fibonacci and Binary search"))
    ...
    def Randomize(self):
        ...
        try:
            ...
            key = {'x': numpy.arange(len(Fibonacci)) + 1, 'height': numpy.array(Fibonacci)}
            self.bar_drawing.setOpts(**key)
            self.graphicsView.addItem(self.bar_drawing)
    ...
    def FiboCall(self):
        ...
        try:
            requested_number = self.Requested.text()
            ...
            self.FiboResult.setText("Please enter an integer number")
